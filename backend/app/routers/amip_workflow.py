...
Exposes endpoints to trigger autonomous multi-agent workflows, cancel executions, and retrieve audit bundles.
"""
...
router = APIRouter(prefix="/api/amip/workflows", tags=["AMIP Workflows"])
